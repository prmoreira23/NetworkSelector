...
normalization(jitter, 1, 0)
normalization(delay, 1, 0)
normalization(packet_loss, 1, 0)
normalization(signal_level, 1, 0)
normalization(throughput, 1, 0)
normalization(cost, 1, 0)
